...
export class TKMCanvasAreaDrawComponent implements AfterViewInit {
  ...
  private drawPolygon(polygon: number[][], isActive: boolean): void {
    ...
    // Get color from palette (use activePolygon index or default to 0)
    const colorIndex =
      this.activePolygon >= 0
    ...
    // Keep your existing outline and points logic
